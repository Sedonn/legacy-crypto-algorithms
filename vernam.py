...
class Vernam:
    ...
    def __xor_str(message: str, key: str) -> str:
        '''Function for "xor" all string with specific key'''
        def __xor(first: str, second: str) -> str:
            '''Function for "xor" two chars '''
    ...
    def encode(message: str, key: str) -> str:
        '''Encode the message with "xor" and encode result to hex with UTF-8 encoding for correct display'''
    ...
    def decode(message: str, key: str) -> str:
        '''Decode hex to string with UTF-8 and "xor" it '''
